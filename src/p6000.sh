...
python main.py ctdet --arch fatnetfrndasppdcndlalk416se --dataset pascal --gpus 0,1,2,3,4,5,6,7 --wh_weight 0.02 --down_ratio 1 --input_res 192 --num_epochs 210 --lr_step 135,180 --batch_size 32 --lr 1.25e-3 --exp_id fatnet_frn_pascal_192_daspp_dcn_dla_lk_se_416_lr10x_wh_002
python test.py ctdet --arch fatnetfrndasppdcndlalk416se --dataset pascal --gpus 0,1,2,3,4,5,6,7 --wh_weight 0.02 --down_ratio 1 --input_res 192 --num_epochs 210 --lr_step 135,180 --batch_size 32 --lr 1.25e-3 --exp_id fatnet_frn_pascal_192_daspp_dcn_dla_lk_se_416_lr10x_wh_002 --resume

python main.py ctdet --arch fatnetfrndasppdcndlalk416se --dataset coco2014 --gpus 0,1,2,3,4,5,6,7 --wh_weight 0.02 --down_ratio 1 --input_res 192 --batch_size 32 --lr 12.5e-3 --exp_id fatnet_frn_coco_192_daspp_dcn_dla_lk_se_416_lr10x_wh_002 --num_workers 16 --val_intervals 20
python test.py ctdet --arch fatnetfrndasppdcndlalk416se --dataset coco2014 --gpus 0,1,2,3,4,5,6,7 --wh_weight 0.02 --down_ratio 1 --input_res 192 --batch_size 32 --lr 12.5e-3 --exp_id fatnet_frn_coco_192_daspp_dcn_dla_lk_se_416_lr10x_wh_002 --num_workers 16 --val_intervals 20 --resume
