...
class PosePangNet(nn.Module):
    ...
    def __init__(self, heads, head_conv, **kwargs):
        ...
        self.conv2_1 = TLConv(64, 32, kernel_size=3, stride=1, padding=2, dilation=2)
        self.conv2_2 = TLConv(32, 32, kernel_size=3, stride=1, padding=2, dilation=2)

        self.conv3_1 = TLConv(32, 16, kernel_size=3, stride=1, padding=4, dilation=4)
        self.conv3_2 = TLConv(16, 16, kernel_size=3, stride=1, padding=4, dilation=4)
        self.conv3_3 = TLConv(16, 16, kernel_size=3, stride=1, padding=4, dilation=4)

        self.conv4_1 = TLConv(16, 8, kernel_size=3, stride=1, padding=8, dilation=8)
