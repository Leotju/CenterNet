...
python main.py ctdet --arch fatnetfrntlconv --dataset pascal --gpus 1,2,3 --down_ratio 1 --input_res 96 --num_epochs 210 --lr_step 135,180 --batch_size 192 --wh_weight 0.02 --lr 7.5e-3 --exp_id fatnet_frn_tl_conv_v4_wh002_lr10x_multi_5912_96
