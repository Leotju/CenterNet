...
python main.py ctdet --arch fatnettlconvmlp --dataset pascal --gpus 0,1 --down_ratio 4 --input_res 384 --num_epochs 210 --lr_step 135,180 --batch_size 64 --lr 2.5e-3 --exp_id fatnet_tl_conv_v3_4_mlp_lr10x_multi_5912_384
