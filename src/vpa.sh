...
python main.py ctdet --arch fatnetfrntlconvpredtlv4 --dataset pascal --gpus 0,1 --down_ratio 1 --input_res 96 --num_epochs 210 --lr_step 135,180 --wh_weight 0.02 --batch_size 16 --lr 0.625e-3 --exp_id fatnet_frn_tl_conv_v3_4_pred_tl_conv_v4_wh002_lr10x_multi_5912_96
