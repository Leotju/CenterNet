...
python main.py ctdet --arch fatnetfrntlconv --dataset pascal --gpus 0,1 --down_ratio 1 --input_res 96 --num_epochs 210 --lr_step 135,180 --batch_size 32 --wh_weight 0.02 --lr 1.25e-3 --exp_id fatnet_frn_tl_conv_v3_wh002_lr10x_multi_5912_more_glo_re

python main.py ctdet --arch fatnetfrntlconv --dataset pascal --gpus 0,1 --down_ratio 4 --input_res 384 --num_epochs 210 --lr_step 135,180 --lr 1.25e-3 --exp_id fatnet_frn_tl_conv_v3_lr10x_multi_5912_more_glo_re_pool4
...
python main.py ctdet --arch resdcn_18 --dataset pascal07 --gpus 0,1 --down_ratio 4 --input_res 384 --num_epochs 210 --lr_step 135,180  --lr 1.25e-3 --exp_id resnet_18_dcn_384_10x_scratch_07
...
python main.py ctdet --arch fatnetfrntlconv --dataset pascal07 --gpus 0,1 --down_ratio 4 --input_res 384 --num_epochs 210 --lr_step 135,180 --batch_size 32 --lr 1.25e-3 --exp_id fatnet_frn_tl_conv_lr10x_multi_5912_conv1pool_lk11_d2_pascal07
...
python main.py ctdet_ms --arch fatnettlconvms --dataset pascal --gpus 0,1,2,3,4,5,6,7 --down_ratio 4 --input_res 384 --num_epochs 210 --lr_step 135,180 --batch_size 64 --lr 2.5e-3 --exp_id fatnet_tlconv_d4_ms_lr10x
