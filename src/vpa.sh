...
python main.py ctdet --arch fatnettlconvpredtlv4 --dataset pascal --gpus 0,1 --down_ratio 4 --input_res 384 --num_epochs 210 --lr_step 135,180 --batch_size 1 --lr 1.25e-3 --exp_id fatnet_tl_conv_v3_4_pred_tl_conv_v4_lr10x_multi_5912_384
