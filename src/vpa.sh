...
python main.py ctdet --arch fatnetfrntlconvmlp --dataset pascal --gpus 1,2,3 --down_ratio 1 --input_res 96 --num_epochs 210 --lr_step 135,180 --batch_size 96 --wh_weight 0.02 --lr 3.75e-3 --exp_id fatnet_frn_tl_conv_v3_4_mlp_wh002_lr10x_multi_5912_96
