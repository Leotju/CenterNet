...
python main.py ctdet_ms --arch fatnettlconvms --dataset pascal07 --gpus 0,1 --down_ratio 4 --input_res 384 --num_epochs 210 --lr_step 135,180 --batch_size 16 --lr 0.625e-3 --exp_id fatnet_tlconv_d4_ms_lr10x
