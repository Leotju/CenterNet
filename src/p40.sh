...
python main.py ctdet --arch resdcn_18 --dataset pascal --gpus 0,1,2,3 --down_ratio 1 --input_res 384 --num_epochs 70 --lr_step 45,60 --batch_size 32 --wh_weight 0.02 --lr 2.5e-4 --exp_id resnet_18_dcn_wh_002_d1_dcn_up
